...
import io.github.lumklar.sortrss.common.foundation.shared.ability.id.DataSourceIdGenerator
...
class IdGeneratorBeanConfig {
    ...
    // 注册 ExternalIdentityIdGenerator
    @Bean
    fun dataSourceIdGenerator(): IdGenerator<DataSourceId> {
        return DataSourceIdGenerator()
    }
}